...
class WeatherDetailDataResponse {
  Location? location;
  Current? current;
  Forecast? forecast;

  WeatherDetailDataResponse({this.location, this.current, this.forecast});

  WeatherDetailDataResponse.fromJson(Map<String, dynamic> json) {
...
// Function to convert a JSON string into a WeatherDetailDataResponse object.
WeatherDetailDataResponse weatherDetailData(String str) {
  final jsonData = json.decode(str);

  return WeatherDetailDataResponse.fromJson(jsonData);
}
